...
def main():
    ...
    cont = True #I think this is not being used
    ...
    while True:
        ...
        if (homeScreen):
            ...
            cv2.rectangle(img, (25,250), (200,300),(255,100,0), -1) # Button
            cv2.putText(img, "Rock, Paper, Scissors", (175, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
            cv2.putText(img, "Rock breaks Scissors", (25, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
            cv2.putText(img, "Paper covers Rock", (25, 132), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
            cv2.putText(img, "Scissors cut Paper", (25, 162), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
            
            cv2.putText(img, "Hover over button to start", (185, 200), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 0), 2)
            cv2.putText(img, "Lets Play", (25, 275), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 0), 2)
            if(len(detector.lmList) > 0):
                if (detector.onButton(25, 250, 200, 400)):# Over the play button
                    ...
                    while delay >= 0:
                        ...
                        if winner == " wins!":
                            ...
                            if delay <= 50: #condition to add a delay to the winner display
                                cv2.putText(img, winner , (150, 140), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 3)
                        cv2.imshow("Image", img)
                        cv2.waitKey(1)
                        delay -= 1
                        #print("Test ", delay)
        ...
        #Altered Tutorial button to Quit button, shows a tally for the human, computer, and ties   
            ...
            cv2.putText(img, "Human " + str(hCount), (100, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
            cv2.putText(img, "Computer " + str(cCount), (100, 140), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
            cv2.putText(img, "Tie " + str(tCount), (100, 240), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
            if hCount > cCount:
                topDog = "Human wins!"
            elif hCount < cCount:
                ...
                topDog = "No winner :("
            cv2.putText(img, topDog, (150, 365), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
